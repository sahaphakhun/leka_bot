...
🎯 ฟีเจอร์สำคัญ (ใช้ในแชทได้ทั้งหมด เว็บเป็นส่วนเสริม):
• ✚ เพิ่มงานใหม่ (รองรับวันเวลา, ผู้รับผิดชอบ, แท็ก, ระดับความสำคัญ)
• 📎 ส่งงานแนบไฟล์ (แชท: ส่งไฟล์ + /submit หรือ เว็บ: แนบไฟล์ในหน้า)
• ✅ ตรวจงาน: อนุมัติ / ตีกลับ พร้อมความเห็น + กำหนดส่งใหม่
• 🔁 งานประจำ: ตั้งรอบรายสัปดาห์/รายเดือน ระบบสร้างให้อัตโนมัติ
• ⏰ เตือนกำหนดส่ง, ติดตามงานเกินกำหนด และตรวจล่าช้า
• 🗂 คลังไฟล์ แยก “ระหว่างส่งงาน/สำเร็จแล้ว”
• 🏆 Leaderboard และสถิติกลุ่ม`;
  ...
  private getHelpMessage(): string {
    return `📖 คำสั่งเลขาบอท (อัปเดต)

🔧 การตั้งค่า
• /setup — ลิงก์เข้า Dashboard กลุ่ม
• /whoami — ดูข้อมูลของฉัน

📋 งาน
• เพิ่มงาน: พิมพ์ “เพิ่มงาน \"ชื่องาน\" @คน @me due dd/mm hh:mm” หรือ “/task add …”
• รายการงาน: /task list [today|week|pending]
• งานของฉัน: /task mine
• เลื่อนงาน: /task move <รหัสงาน|ชื่อ> <วันเวลาใหม่>

📎 ส่งงานแนบไฟล์
• วิธีที่ 1 (แชท): ส่งไฟล์ในกลุ่ม → พิมพ์ “/submit <รหัสงาน|ชื่อ> [หมายเหตุ]”
• วิธีที่ 2 (เว็บ): เปิด Dashboard → ส่งงาน (แนบไฟล์)

✅ ตรวจงาน
• อนุมัติ: /approve <รหัสงาน|ชื่อ>
• ตีกลับ: /reject <รหัสงาน|ชื่อ> <กำหนดส่งใหม่> [ความเห็น]

🔁 งานประจำ
• ตั้งค่าใน Dashboard ให้สร้างงานอัตโนมัติทุกสัปดาห์/เดือน

🗂 คลังไฟล์
• /files list — ดูไฟล์ล่าสุด
• /files search <คำค้น> — ค้นหาไฟล์
• ระบบแยกไฟล์: “ระหว่างส่งงาน” และ “สำเร็จแล้ว” อัตโนมัติเมื่อปิดงาน

⏰ เตือน/ติดตาม
• เตือนก่อนครบกำหนด, แจ้งงานเกินกำหนด, ทำเครื่องหมาย “ตรวจล่าช้า” เมื่อเกิน 2 วัน

🌐 Dashboard: ${config.baseUrl}/dashboard?groupId=<ID_กลุ่ม>`;
  }
