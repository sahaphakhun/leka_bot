// Enhanced moment-timezone replacement for CSP compliance
(function() {
  'use strict';
  ...
  if (typeof window !== 'undefined' && window.moment) {
    ...
    // Add proper timezone formatting
    moment.fn.formatInTimezone = function(format, timezone) {
      if (timezone === 'Asia/Bangkok') {
        var bangkokMoment = this.toBangkok();
        return bangkokMoment.format(format);
      }
      return this.format(format);
    };
    
    // Add timezone-aware date creation
