...
### 2. ตั้งค่าเริ่มต้น (สำหรับผู้ดูแลกลุ่ม)
...
#### 🔧 การตั้งค่า
```
@เลขา /setup          # ตั้งค่าเริ่มต้น (admin เท่านั้น)
...
**สร้างงานแบบธรรมชาติ:**
```
@เลขา เพิ่มงาน "ปิดงบเดือนกรกฎาคม" ให้ @ต๋อง @แหม่ม เริ่ม 29/07 09:00 ถึง 29/07 11:00 เตือนล่วงหน้า 1วัน, 2ชม #การเงิน
```

**สร้างงานแบบคำสั่ง:**
```
@เลขา /task add "ประชุมลูกค้า A" @บอล @โอม due 31/07 14:00 -remind 24h,2h #sales
```

**จัดการงาน:**
```
@เลขา /task list              # ดูรายการงาน
@เลขา /task list วันนี้        # งานวันนี้
@เลขา /task list สัปดาห์       # งานสัปดาห์นี้
