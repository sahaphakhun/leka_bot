...
exports.ActivityLog = exports.RecurringTask = exports.KPIRecord = exports.File = exports.Task = exports.GroupMember = exports.User = exports.Group = void 0;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => User, (user) => user.groupMemberships, {
        onDelete: "CASCADE",
    }),
...
__decorate([
    (0, typeorm_1.Column)({ type: "uuid" }),
    __metadata("design:type", String)
], ActivityLog.prototype, "groupId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: "uuid", nullable: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Group, { onDelete: "CASCADE" }),
    (0, typeorm_1.JoinColumn)({ name: "groupId" }),
    __metadata("design:type", Group)
], ActivityLog.prototype, "group", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => User, { onDelete: "SET NULL", nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: "userId" }),
    __metadata("design:type", User)
